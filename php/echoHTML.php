            ...
            <div class="tools-member">
                <div class="member">
                    ...
                    <div class="menuMember hide">
                        <a href="nguoidung.php">Thông tin tài khoản</a>
...
function addHome()
{
    ...
    <div class="timNangCao">
        <div class="flexContain">
            ...
            <div class="starFilter dropdown" style="display: none; visibility: hidden;">
                ...
                <div id="signup">
                    ...
                    <form action="" method="post" name="formDangKy" onsubmit="return checkDangKy();">
                        ...
                        <div class="field-wrap">
                            ...
                            <input name="re-Pass" id="re-Pass" type="password" required autocomplete="off" />
                        </div> <!-- /pass -->
